...
export function PendingTask({ taskArray, onClickHandler, setWantsToUpdate}){
    ...
    return(
        <div className="h-[94%] flex flex-col justify-around">
            <h2 className="mb-[10px] text-black h-[18%] w-full flex justify-center items-center text-[40px] font-Poppins font-semibold bg-white rounded-t-[70px] shadow-[0px_0px_1.5px_0px_rgba(0,0,0,0.75)]">{title}</h2>
